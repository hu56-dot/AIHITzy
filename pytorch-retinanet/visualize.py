...
def main(args=None):
	...
	parser.add_argument('--csv_classes', help='Path to file containing class list (see readme)',default='./class_list.csv')
	parser.add_argument('--csv_val', help='Path to file containing validation annotations (optional, see readme)',default='./val_annots.csv')

	parser.add_argument('--model', help='Path to model (.pt) file.',default='./model_final.pt')
